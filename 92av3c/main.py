...
indexi=sio.loadmat('92av3c_spatialdata.mat')['indexi']
indexj=sio.loadmat('92av3c_spatialdata.mat')['indexj']
X_spatial=sio.loadmat('92av3c_spatialdata.mat')['X_LSTM']

X_spatial=np.reshape(X_spatial,[10366,9,9,200])
...
x_stream1=layers.Conv2DTranspose(200,(5,5),strides=(1,1),padding='valid',kernel_regularizer=kernel_regularizer)(x_stream1)
x_stream1=layers.LeakyReLU()(x_stream1)
x_stream1=layers.BatchNormalization()(x_stream1)
...
generator.summary()
######################   discriminator    #####################################
discriminator_input1=layers.Input(shape=(9,9,200))
discriminator_input2=layers.Input(shape=(9,9,flow_X_spatial1.shape[3],200))
...
###################################module1#####################################
x_true_1=layers.Input(shape=(9,9,200))
x_true1=layers.Reshape((9,9,200))(x_true_1)

x_true_2=layers.Input(shape=(9,9,flow_X_spatial1.shape[3],200))
x_true2=x_true_2
...
for i in range(iterations):
    ...
    if i%500==0:
        finalfeature=feature_extractor.predict([np.reshape(X_spatial,[10366,9,9,200]),flow_X_spatial1])
